...
#   15.5,28.5,52.5,96.5,177.5,326.5,600.5,1104.5,2031.5,3736.5,6872.5,12640.5,
#   23249.5,42762.5,78652.5,144664.5,266079.5,489396.5,900140.5,1655616.5,
...
def tribonacci(signature,n)
  output = signature
  (n - output.size).times { output << output.last(3).reduce(:+) }
  p output
end
