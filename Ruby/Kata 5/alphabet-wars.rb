...
# The letters hide in their nuclear shelters. The nuclear strikes
# hit the battlefield and killed a lot of them.
#
# Task
# Write a function that accepts battlefield string and returns
# letters that survived the nuclear strike.
#
# The battlefield string consists of only small letters, #,[ and ].
# The nuclear shelter is represented by square brackets []. The
# letters inside the square brackets represent letters inside the shelter.
# The # means a place where nuclear strike hit the battlefield. If
# there is at least one # on the battlefield, all letters outside of
# shelter die. When there is no any # on the battlefield, all letters
...
# ##abde[fgh]ijk[mn]op => "mn" (letters from the second shelter survive, there
# is no # close)
# #ab#de[fgh]ijk[mn]op => "mn" (letters from the second shelter survive, there
# is no # close)
# #abde[fgh]i#jk[mn]op => "mn" (letters from the second shelter survive, there
# is only 1 # close)
# [a]#[b]#[c]  => "ac"
# [a]#b#[c][d] => "d"
# [a][b][c]    => "abc"
