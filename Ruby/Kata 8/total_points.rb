...
#   it "Basic tests" do
#     Test.assert_equals(points(['1:0','2:0','3:0','4:0',
#       '2:1','3:1','4:1','3:2','4:2','4:3']),30)
#
#     Test.assert_equals(points(["1:1","2:2","3:3","4:4",
#       "2:2","3:3","4:4","3:3","4:4","4:4"]),10)
#
#     Test.assert_equals(points(["0:1","0:2","0:3","0:4",
#       "1:2","1:3","1:4","2:3","2:4","3:4"]),0)
#
#     Test.assert_equals(points(["1:0","2:0","3:0","4:0",
#       "2:1","1:3","1:4","2:3","2:4","3:4"]),15)
#
#     Test.assert_equals(points(["1:0","2:0","3:0","4:4",
#       "2:2","3:3","1:4","2:3","2:4","3:4"]),12)
#
#   end
# end
...
def points(games)
  total = []
  games.map do |results|
    test = results.split(":")
    if test.first == test.last
      total << 1
    elsif test.first.to_i > test.last.to_i
      total << 3
    else
      total << 0
    end
