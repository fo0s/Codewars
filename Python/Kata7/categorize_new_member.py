...
# (in Haskell: Open or Senior) stating whether the respective member
...
# test.assert_equals(openOrSenior(
#     [[45, 12], [55, 21], [19, -2], [104, 20]]), ['Open', 'Senior', 'Open', 'Senior'])
# test.assert_equals(openOrSenior([[16, 23], [73, 1], [56, 20], [
#                    1, -1]]), ['Open', 'Open', 'Senior', 'Open'])

def openOrSenior(data):
    output = []
    for member in data:
        if member[0] > 54 and member[-1] > 7:
